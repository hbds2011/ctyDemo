...
locale['No matches found'] = 'No matches found';locale['More matches found...'] = 'More matches found...';locale['type here to search'] = 'type here to search';locale['new'] = 'new';locale['Select'] = 'Select';/*
** Zabbix
...
jQuery(document).ready(
  function() { 
    initMessages({});
    jQuery("#groupids_").multiSelect(
      {
        "url":"jsrpc.php?sid=2a11a919e7d05bb2&type=11&method=multiselect.get&objectName=hostGroup",
        "name":"groupids[]",
        "labels":{"No matches found":"No matches found","More matches found...":"More matches found...","type here to search":"type here to search","new":"new","Select":"Select"},
        "data":[
        {"id":"2","name":"Linux servers"},
        {"id":"7","name":"Misc"},
        {"id":"9","name":"Pseudo-hosts"},
        {"id":"6","name":"Web pages"}],
        "ignored":null,
        "defaultValue":null,
        "disabled":false,
        "selectedLimit":null,
        "addNew":false,
        "popup":{"parameters":"srctbl=host_groups&dstfrm= zbx_filter&dstfld1=groupids_&srcfld1=groupid&multiselect=1","width":450,"height":450}
      });

    jQuery("#hostids_").multiSelect(
      {
        "url":"jsrpc.php?sid=2a11a919e7d05bb2&type=11&method=multiselect.get&objectName=hosts",
        "name":"hostids[]",
        "labels":{"No matches found":"No matches found","More matches found...":"More matches found...","type here to search":"type here to search","new":"new","Select":"Select"},
        "data":[],
        "ignored":null,
        ...
        "selectedLimit":null,
        "addNew":false,
        "popup":{"parameters":"srctbl=hosts&dstfrm= zbx_filter&dstfld1=hostids_&srcfld1=hostid&real_hosts=1&multiselect=1","width":450,"height":450}
      });
